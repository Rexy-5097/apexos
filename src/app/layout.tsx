...
const SITE_URL = `https://${BRANDING.domain}`;
const SITE_NAME = BRANDING.displayName;
const SITE_TITLE = `${BRANDING.displayName} — Open Source Intelligence Platform | Live Flight Tracking, CCTV, OSINT Tools & More`;
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: `%s | ${BRANDING.displayName} Intelligence`,
  },
  ...
  authors: [{ name: `${BRANDING.displayName} Project`, url: SITE_URL }],
  creator: `${BRANDING.displayName} Project`,
  publisher: `${BRANDING.displayName} Project`,
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: `${BRANDING.displayName} — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${BRANDING.displayName} — Open Source Intelligence Platform with Live Tracking & OSINT Tools`,
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: `🛰️ ${BRANDING.displayName} — Open Source Palantir Alternative | Live Tracking + OSINT Tools`,
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: `${BRANDING.displayName} — OSINT Toolkit & Intelligence Platform`,
  alternateName: [BRANDING.displayName, `${BRANDING.displayName} OSINT`],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
  ...
  author: {
    "@type": "Organization",
    name: `${BRANDING.displayName} Project`,
    url: SITE_URL,
  },
};
  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        <ErrorBoundary name={`${BRANDING.displayName} Core`}>
          {children}
        </ErrorBoundary>
      </body>
    </html>
